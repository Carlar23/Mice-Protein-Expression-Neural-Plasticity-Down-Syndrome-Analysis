...
|:---|:---:|:---|
| `pERK_N` | 18.9% | MAPK pathway — synaptic plasticity and memory |
...
```bash
git clone https://github.com/your-username/mice-protein-expression.git
cd mice-protein-expression
```
...
- Source: [UCI Machine Learning Repository](https://archive.ics.uci.edu/ml/datasets/Mice+Protein+Expression)
